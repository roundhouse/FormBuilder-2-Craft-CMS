...
class FormBuilder2Plugin extends BasePlugin
{
    ...
    public function init()
    {
        ...
        if (craft()->request->isCpRequest() && craft()->request->getSegment(1) == 'formbuilder2') {
            craft()->templates->includeJsResource('formbuilder2/js/branding.js');
            craft()->templates->includeJs("
            FormBuilder2Branding = new Craft.FormBuilder2Branding();
            FormBuilder2Branding.displayFooter({
    ...
    */
    ...
    public function prepCpTemplate(&$context)
    {
        ...
        if (craft()->userSession->isAdmin() || $pluginSettings->canDoActions) {
            ...
            $context['subnav']['createnewform'] = array('icon' => 'plus', 'label' => Craft::t('Create New Form'), 'url' => 'formbuilder2/forms/new');
        }
    }
    ...
    public function registerCpRoutes()
    {
        return array(
            ...
            'formbuilder2/templates/new'                                        => array('action' => 'formBuilder2_Template/edit'),
            'formbuilder2/templates/(?P<type>[^\/]+)/(?P<templateId>\d+)'       => array('action' => 'formBuilder2_Template/edit'),
            'formbuilder2/templates/(?P<type>[^\/]+)/(?P<templateId>\d+)/edit'  => array('action' => 'formBuilder2_Template/edit'),
            'formbuilder2/templates/(?P<type>[^\/]+)/new'                       => array('action' => 'formBuilder2_Template/edit')
        );
    }
}
