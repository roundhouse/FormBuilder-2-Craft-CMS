...
Craft.FormBuilder2.EntriesTableView = Craft.TableElementIndexView.extend({
    ...
    {
        return Craft.FormBuilder2.EntriesTableView.getStorage(this.elementIndex._namespace, key);
    },

    setStorage: function(key, value)
    {
        Craft.FormBuilder2.EntriesTableView.setStorage(this.elementIndex._namespace, key, value);
    },
    ...
    {
        if (this.setStartDate(Craft.FormBuilder2.EntriesTableView.getDateFromDatepickerInstance(this.startDatepicker)))
        {
            this.loadReport();
        }
    },
    ...
    {
        if (this.setEndDate(Craft.FormBuilder2.EntriesTableView.getDateFromDatepickerInstance(this.endDatepicker)))
        {
            this.loadReport();
        }
    },
    ...
    loadReport: function()
    {
        ...
        requestData.startDate = Craft.FormBuilder2.EntriesTableView.getDateValue(this.startDate);
        requestData.endDate = Craft.FormBuilder2.EntriesTableView.getDateValue(this.endDate);

        this.$spinner.removeClass('hidden');
        this.$error.addClass('hidden');
        this.$chart.removeClass('error');

        Craft.postActionRequest('formBuilder2/charts/getEntriesData', requestData, $.proxy(function(response, textStatus)
        {
...
},
{
    ...
    {
        if (Craft.FormBuilder2.EntriesTableView.storage[namespace] && Craft.FormBuilder2.EntriesTableView.storage[namespace][key])
        {
            return Craft.FormBuilder2.EntriesTableView.storage[namespace][key];
        }
    ...
    {
        if (typeof Craft.FormBuilder2.EntriesTableView.storage[namespace] == typeof undefined)
        {
            Craft.FormBuilder2.EntriesTableView.storage[namespace] = {};
        }

        Craft.FormBuilder2.EntriesTableView.storage[namespace][key] = value;
    },
